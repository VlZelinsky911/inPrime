...
export const SITE_CONFIG = {
  ...
  description: 'Join the community of professional traders. Get up-to-date signals and support 24/7.',
};
...
export const FEATURES = [
  {
    id: 1,
    title: 'Analytics',
    description: 'Exclusive analytics from our experts. Daily forecasts and analysis.',
