...
const FeatureItem = ({ 
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="relative bg-neutral-900/80 border border-neutral-800 rounded-2xl overflow-hidden">
            ...
            <div className="p-8 flex flex-col items-center justify-center min-h-[200px]">
              ...
              <p className="text-gray-500 text-sm">Screenshot: {feature.title}</p>
              <p className="text-gray-600 text-xs mt-1">Upload screenshots to public/images/</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      {/* Text Content */}
      <div className={`flex-1 w-full ${isReversed ? 'lg:pr-8 lg:text-right' : 'lg:pl-8'}`}>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-4">Everything you need for successful trading</p>
          </div>

          {/* Benefits Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { icon: '📈', title: 'Trading Signals', desc: 'Up-to-date signals with detailed analysis' },
              { icon: '📚', title: 'Education', desc: 'Video tutorials and strategy breakdowns' },
              { icon: '👥', title: 'Community', desc: 'Chat with professionals 24/7' },
