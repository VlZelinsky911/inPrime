      ...
      <div className="relative z-20 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-gray-400 text-sm tracking-wide">Private community of traders</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-xl">
              <span className="text-white font-semibold">Get up-to-date signals</span>
